...
- [Advanced Pipeline Examples](#advanced-pipeline-examples)
  ...
  - [Materialization Strategies](#materialization-strategies)
    - [NONE (default) - In-memory only](#none-default---in-memory-only)
    - [REPLACE - Full table overwrite](#replace---full-table-overwrite)
    - [APPEND - Incremental loads](#append---incremental-loads)
    - [SQL Syntax](#sql-syntax)
    - [OVERWRITE\_PARTITIONS - Selective partition replacement](#overwrite_partitions---selective-partition-replacement)
  - [DuckDB in Python Models](#duckdb-in-python-models)
    - [Python Model with Multiple Inputs](#python-model-with-multiple-inputs)
  ...
  - [Multi-Stage Pipeline Example](#multi-stage-pipeline-example)
    ...
    - [bauplan\_project.yml](#bauplan_projectyml)
    - [models.py](#modelspy)
    - [expectations.py](#expectationspy)
